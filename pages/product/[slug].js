      ...
      <section className="text-gray-600  body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto  px-11 object-cover object-center rounded"
              src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T2/images/I/81WEWRolGiL._UL1500_.jpg"
            />
